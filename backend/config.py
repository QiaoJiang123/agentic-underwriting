...
AGENT_TRACE_DIR = ROOT / "data" / "agent_traces"
ANALYTICS_DIR = ROOT / "data" / "analytics"
ANALYTICS_DB_PATH = ANALYTICS_DIR / "underwriting_claim_analytics.db"
SECURITY_DIR = ROOT / "data" / "security"
AUTH_POLICY_PATH = SECURITY_DIR / "auth_policy.json"
AUTH_DB_PATH = SECURITY_DIR / "auth.db"
AUDIT_DIR = ROOT / "data" / "audit"
ACCESS_AUDIT_PATH = AUDIT_DIR / "access_audit.jsonl"
