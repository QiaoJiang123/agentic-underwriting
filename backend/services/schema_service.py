...
SCHEMAS = {
    ...
    "decision_package_record": {
        ...
        "required": [
            ...
            "rating_quote",
            "model_governance",
            "underwriter_controls",
            "citations",
        ],
        "properties": {
            "submission_id": {"type": "string", "minLength": 1},
            "package_type": {"type": "string", "enum": ["quote", "referral", "bind", "review"]},
            "generated_at": {"type": "string"},
            ...
            "evidence": {
                "type": "object",
                "required": ["required_count", "received_count", "missing_count", "readiness_ratio"],
                "properties": {
                    "required_count": {"type": "number"},
                    "received_count": {"type": "number"},
                    "missing_count": {"type": "number"},
                    "readiness_ratio": {"type": "number"},
                    "received": {"type": "array"},
                    "missing": {"type": "array"},
                },
            },
            ...
            "rating_quote": {"type": "object"},
            "clearance": {"type": "object"},
            "external_research": {"type": "object"},
            "model_governance": {"type": "object"},
            "underwriter_controls": {"type": "array", "items": {"type": "string"}, "minItems": 1},
            "citations": {
                "type": "array",
                "minItems": 1,
                "items": {
