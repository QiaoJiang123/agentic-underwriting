...
ROUTE_RULES = [
    ...
    ("GET", r"^/api/submissions/([^/]+)/(claims|underwriting|clearance|external-research|rating-quote|decision-workflow|chat-history|agent-traces|guides|notes|tasks|states)$", "submission:read"),
